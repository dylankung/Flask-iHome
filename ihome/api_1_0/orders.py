...
from . import api
from ihome.tasks.orders import tasks
...
def save_order():
    ...
    # result = tasks.save_order.delay(user_id, house_id, start_date_str, end_date_str, house.price)
    # order_id = result.get()
    # print(order_id)
    # if order_id > 0:
    #     return jsonify(errno=RET.OK, errmsg="OK", data={"order_id": order_id})
    # else:
    #     return jsonify(errno=RET.DATAERR, errmsg="failed")
